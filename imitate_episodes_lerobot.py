...
from utils import load_lerobot_data # data functions
...
def main(args):
    ...
    n_obs_steps = task_config.get('n_obs_steps', 1)
    if policy_class == 'ACTTask':
        state_dim = 10 * n_obs_steps
        action_dim = 10
    else:
        state_dim = task_config['model_dof'] * n_obs_steps
        action_dim = task_config['model_dof']
    gripper_is_binary = task_config.get('gripper_is_binary', True)
    ...
    if policy_class.startswith('ACT'):
        ...
        policy_config = {'lr': args['lr'],
                         ...
                         'gripper_is_binary': gripper_is_binary
                         }
    ...
    wandb.init(
        ...
        config={
            ...
            "model dof": action_dim,
            "num episodes": num_episodes,
            "ckpt dir": ckpt_dir,
            "n_obs_steps": n_obs_steps,
            "chunk size": args['chunk_size'],
            "state_key": task_config.get('state_key', 'observation.state'),
            "action_key": task_config.get('action_key', 'action'),
    ...
    train_dataloader, val_dataloader, stats, _ = load_lerobot_data(task_config, args['chunk_size'], batch_size_train, batch_size_val)
...
--policy_class ACT --kl_weight 10 --chunk_size 20 --hidden_dim 512 \
--batch_size 32 --dim_feedforward 3200 --num_epochs 5000 --lr 4e-5 --seed 0 \
--task_name sim_lerobot_pusht --ckpt_dir /home/lyh/Data/ckpt/act/pusht
'''
